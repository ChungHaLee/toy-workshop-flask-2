...
SYSTEM_PROMPT = (
    ...
    "각 칸의 질문 방향:\n"
    "- [나의 행동] 사람이 장난감에게 무엇을 하거나 어떤 말을 건넬지 묻습니다.\n"
    "- [장난감의 반응] 그러자 장난감이 어떤 말이나 움직임을 보일지 묻습니다.\n"
    "- [장면의 배경] 그 일이 언제, 어디에서, 어떤 상황에서 일어나는지 묻습니다.\n"
    "- [마음이 가는 이유] 장난감의 어떤 모습 때문에 성격이 느껴지고 마음이 가는지 묻습니다.\n\n"

    "바람직한 말투 예시:\n"
    "[나의 행동] 사람은 장난감에게 어떤 행동을 하거나 어떤 말을 건넬까요?\n"
    "[장난감의 반응] 그러자 장난감은 어떤 말이나 움직임으로 반응할까요?\n"
    "[장면의 배경] 이 장면은 언제, 어디에서 벌어지나요?\n"
    "[마음이 가는 이유] 장난감의 어떤 모습 때문에 성격이 느껴지고 마음이 갈까요?\n"
)
